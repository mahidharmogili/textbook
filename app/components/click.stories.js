...
export default {
  ...
  const Template = args => ({
    template: hbs`<Click 
   @name={{this.button.name}} @size={{this.button.size}} @google={{this.button.google}} @facebook={{ this.button.facebook}} @twitter={{this.button.twitter}}  @iconUrl={{this.button.iconUrl}} />`,
    context: args,
  });
...
Google.args = {
  button: {
    ...
    google: true,
    size: 'w-44 h-14',
    iconUrl: "public/images/Xos3xQfk.jpg"
  },
};
...
Twitter.args = {
  button: {
    ...
    twitter: true,
    size: 'w-44 h-14',
    iconUrl: "https://png.pngtree.com/element_our/png/20181011/twitter-social-media-icon-design-template-vector-png_127095.jpg"
  },
};